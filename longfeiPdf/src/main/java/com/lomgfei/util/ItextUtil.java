...
public class ItextUtil {
    ...
    public static void main(String[] args) {
        try {
            //keytool -importcert -keystore client_trust.keystore -file longfei.cer -alias client_trust_server -noprompt
           // keytool -exportcert -keystore longfei.keystore -file longfei.cer -alias serverkey
            //keytool -importkeystore -srckeystore longfei.keystore -destkeystore longfei.p12 -srcalias serverkey -destalias serverkey -srcstoretype jks -deststoretype pkcs12 -noprompt
            ItextUtil app = new ItextUtil();
            // 将证书文件放入指定路径，并读取keystore ，获得私钥和证书链
            String pkPath = "F:/Java/bin/longfei.p12";
            ...
            // 签章图片
            signInfo.setImagePath("E:/sign.png");
            ...
            //签章后的pdf路径
            app.sign(path, "E:/demo4.pdf", signInfo);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
